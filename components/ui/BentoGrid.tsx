...
export const BentoGridItem = ({
  ...
  const rightLists = ["AWS", "JavaScript  ", "SQL"];
  ...
  const handleCopy = () => {
    const text = "sagarhedaoo@gmail.com";
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(237,151,79,100) 60%)",
      }}
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          <div className="font-sans font-extralight text-black-100 text-sm md:text-xs lg:text-base z-10">
            {description}
          </div>
              ...
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                {leftLists.map((item, i) => (
                  <span
                    ...
                    lg:opacity-100 rounded-lg text-center bg-[#000000]"
                  >
                    {item}
                  </span>
                ))}
